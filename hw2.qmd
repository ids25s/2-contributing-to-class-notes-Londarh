...
**a. Create a fork of the notes repo into your own GitHub account.**
  ...
  We go to the link and accept the assignment. Now we are on GitHub - copy the SSH key,
  go to appropriate folder on our PC and type `git clone "SSH key"` in VS Code. 
